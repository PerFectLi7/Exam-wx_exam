...
public class QexzConst {
    ...
    public static final String UPLOAD_FILE_PATH = "file:D:/workspace/data/springboot-penguin/upload/";
    public static final String UPLOAD_FILE_IMAGE_PATH = "D:/workspace/data/springboot-penguin/upload/images/";
